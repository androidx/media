...
/** Snippets for troubleshooting.md. */
...
public class Troubleshooting {
  ...
  public static void transformerTroubleshootingSetMaxDelayBetweenMuxerSamplesMs(Context context) {
    // [START set_max_delay_between_samples]
    new Transformer.Builder(context).setMaxDelayBetweenMuxerSamplesMs(C.TIME_UNSET).build();
    // [END set_max_delay_between_samples]
  }
}
