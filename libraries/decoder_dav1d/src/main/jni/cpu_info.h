 ...
 */
#ifndef EXOPLAYER_V2_EXTENSIONS_DAV1D_SRC_MAIN_JNI_CPU_INFO_H_
#define EXOPLAYER_V2_EXTENSIONS_DAV1D_SRC_MAIN_JNI_CPU_INFO_H_
...
// Returns the number of cores online. Returns 0 on error or if the number of
// cores cannot be determined.
int GetNumberOfProcessorsOnline();

}  // namespace dav1d_jni

#endif  // EXOPLAYER_V2_EXTENSIONS_DAV1D_SRC_MAIN_JNI_CPU_INFO_H_
