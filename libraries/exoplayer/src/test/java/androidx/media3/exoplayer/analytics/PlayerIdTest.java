...
public final class PlayerIdTest {
  ...
  /**
   * Two {@link PlayerId} instances should be considered distinct even if they have matching player
   * names.
   *
   * <p>This test runs on all supported API levels, to ensure we cover the case where {@link
