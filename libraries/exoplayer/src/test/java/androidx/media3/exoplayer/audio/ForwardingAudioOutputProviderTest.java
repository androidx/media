...
/** Unit tests for {@link ForwardingAudioOutputProvider}. */
@RunWith(AndroidJUnit4.class)
public class ForwardingAudioOutputProviderTest {

  @Test
  public void overridesAllMethods() throws NoSuchMethodException {
    assertSubclassOverridesAllMethods(
        AudioOutputProvider.class, ForwardingAudioOutputProvider.class);
  }

  @Test
  public void forwardsAllMethods() throws Exception {
    assertForwardingClassForwardsAllMethods(
        AudioOutputProvider.class, ForwardingAudioOutputProvider::new);
  }
}
