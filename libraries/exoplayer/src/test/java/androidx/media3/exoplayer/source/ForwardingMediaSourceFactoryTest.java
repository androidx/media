...
/** Unit tests for {@link ForwardingMediaSourceFactory}. */
@RunWith(AndroidJUnit4.class)
public class ForwardingMediaSourceFactoryTest {

  @Test
  public void overridesAllMethods() throws Exception {
    assertSubclassOverridesAllMethods(
        MediaSource.Factory.class, ForwardingMediaSourceFactory.class);
  }

  @Test
  public void forwardsAllMethods() throws Exception {
    assertForwardingClassForwardsAllMethods(
        MediaSource.Factory.class, ForwardingMediaSourceFactory::new);
  }
}
