...
/** Unit tests for {@link ForwardingAudioOutput}. */
@RunWith(AndroidJUnit4.class)
public class ForwardingAudioOutputTest {

  @Test
  public void overridesAllMethods() throws NoSuchMethodException {
    assertSubclassOverridesAllMethods(AudioOutput.class, ForwardingAudioOutput.class);
  }

  @Test
  public void forwardsAllMethods() throws Exception {
    assertForwardingClassForwardsAllMethods(AudioOutput.class, ForwardingAudioOutput::new);
  }
}
