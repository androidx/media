...
public class DefaultDrmSessionManagerTest {
  ...
  public void acquireSession_retries_reportsMultipleLoadEvents() {
    ...
    MediaDrmCallback clockAdvancingLicenseServer =
        new MediaDrmCallback() {
          ...
          @Override
          public KeyResponse executeProvisionRequest(
              UUID uuid, ExoMediaDrm.ProvisionRequest request) throws MediaDrmCallbackException {
          ...
          @Override
          public KeyResponse executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest request)
  ...
  private static void keyResponseIndicatesProvisioningRequiredProvisioningDone(
      boolean throwNoSuchMethodErrorForNotProvisioned) {
    FakeExoMediaDrm.LicenseServer licenseServer =
        new FakeExoMediaDrm.LicenseServer.Builder().addAllowedSchemeDatas(DRM_SCHEME_DATAS).build();
