...
/** Tests for {@link ForwardingVideoSink}. */
@RunWith(AndroidJUnit4.class)
public class ForwardingVideoSinkTest {

  @Test
  public void overridesAllMethods() throws Exception {
    assertSubclassOverridesAllMethods(VideoSink.class, ForwardingVideoSink.class);
  }

  @Test
  public void forwardsAllMethods() throws Exception {
    assertForwardingClassForwardsAllMethods(VideoSink.class, ForwardingVideoSink::new);
  }
}
