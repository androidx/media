...
@UnstableApi
public final class ContentSteering {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (!(o instanceof ContentSteering)) {
      return false;
    }
    ContentSteering other = (ContentSteering) o;
    return Objects.equals(steeringServerUri, other.steeringServerUri)
        && Objects.equals(defaultServiceLocation, other.defaultServiceLocation)
        && queryBeforeStart == other.queryBeforeStart;
  }

  @Override
  public int hashCode() {
    return Objects.hash(steeringServerUri, defaultServiceLocation, queryBeforeStart);
  }
}
