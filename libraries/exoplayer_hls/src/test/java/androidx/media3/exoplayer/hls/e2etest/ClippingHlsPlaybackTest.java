    ...
    ExoPlayer player =
        new ExoPlayer.Builder(context, capturingRenderersFactory)
            .setMediaSourceFactory(
                new ForwardingMediaSourceFactory(hlsFactory) {
                  @Override
                  public MediaSource createMediaSource(MediaItem mediaItem) {
                    MediaSource hlsSource = super.createMediaSource(mediaItem);
                    hlsSource.addEventListener(testHandler, capturingMediaSourceEventListener);
