...
/** Unit test for {@link PreloadMediaSource} with HLS stream. */
@RunWith(AndroidJUnit4.class)
public final class HlsPreloadMediaSourceTest {
  ...
  public void setUp() {
    ...
    mediaItem =
        new MediaItem.Builder()
            .setUri(Uri.parse("asset://android_asset/media/hls/multi-segment/playlist.m3u8"))
            .build();
