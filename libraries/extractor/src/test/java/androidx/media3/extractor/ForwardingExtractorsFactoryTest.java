...
/** Unit test for {@link ForwardingExtractorsFactory}. */
@RunWith(AndroidJUnit4.class)
public class ForwardingExtractorsFactoryTest {

  @Test
  public void overridesAllMethods() throws Exception {
    assertSubclassOverridesAllMethods(ExtractorsFactory.class, ForwardingExtractorsFactory.class);
  }

  @Test
  public void forwardsAllMethods() throws Exception {
    assertForwardingClassForwardsAllMethods(
        ExtractorsFactory.class, ForwardingExtractorsFactory::new);
  }
}
